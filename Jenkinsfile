pipeline {
    agent any
    environment {
        TF_VAR_gcp_project = "qwiklabs-gcp-04-aebe90b78ea1"
        TF_VAR_bucket = "tf-remote-state-student_01_16a69684793d-28692-13442"
        REPOSITORY = "https://github.com/gitnoob987/cicd02-starter"
